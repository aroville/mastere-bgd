...
public class PublicTestPageRank extends TestCase {	
	...
	public void testJob1Reducer() throws IOException {
		...
		values2.add(new Text("PageD"));
        values2.add(new Text("PageA"));
		job1ReduceDriver.withInput(new Text("PageC"), values2);

		// Add output
		job1ReduceDriver.withOutput(new Text("PageB"),
                new Text("1.0\tPageA"));
		job1ReduceDriver.withOutput(new Text("PageC"),
                new Text("1.0\tPageA,PageD"));
	...
	public void testJob2Mapper() throws IOException {
		...
		job2MapDriver.withInput(new LongWritable(1), new Text(
				"PageB\t1.0\tPageD,PageA"));
		job2MapDriver.withInput(new LongWritable(2), new Text(
				"PageC\t1.0\tPageA"));

		// Set output
		job2MapDriver.withOutput(new Text("PageB"), new Text("!"));
		job2MapDriver.withOutput(new Text("PageA"), new Text("PageB\t1.0\t2"));
		job2MapDriver.withOutput(new Text("PageD"), new Text("PageB\t1.0\t2"));
		job2MapDriver.withOutput(new Text("PageB"), new Text("|PageA,PageD"));
