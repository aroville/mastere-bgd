...
from source import epsilon_greedy, ucb, thompson, compute_lower_bound
...
LB = compute_lower_bound(n_arms, true_means)
...
if False:
    ...
    for eps in epsilon:
        ...
        for exp in np.arange(nMC):
            ...
            for t in time:
                arm_chosen = epsilon_greedy(n_arms, eps, rewards, draws)
